...
#
# See agents/docs/agent-hierarchy.md § "The autonomy dial". The dial is a single
...
echo "What each level permits is defined in agents/docs/agent-hierarchy.md § The"
...
echo "the pre-push gates (WIP scan, CI-workflow-by-name, fetch-merge) always hold."
